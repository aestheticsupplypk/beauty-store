...
export default function HomePresenter({ onAddToCart, startingPrice, colorPrices, colorAvailability, products, primaryGallery }: HomePresenterProps) {
  ...
  const getProductImage = (idx: number, fallbackAlt: string): { src: string; alt: string } => {
    ...
    return { src: '/images/9e6a7339bbd3890af376ef20faeea292.avif', alt: fallbackAlt };
  };
  return (
    <div className="min-h-screen bg-[#FFF7F3]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center space-x-8">
              <Link href="/products" className="text-[#7A1E3A] hover:text-[#5A1226] font-medium transition-colors">Products</Link>
              <Link href="/track-order" className="text-[#7A1E3A] hover:text-[#5A1226] font-medium transition-colors">Track Order</Link>
              <button className="text-[#7A1E3A] hover:text-[#5A1226] relative group">
      ...
      <div className="py-12 bg-[#FFF1EC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="rounded-xl bg-white shadow-sm border border-[#F3E0E7] p-5 space-y-2 text-left">
              <h3 className="font-semibold text-rose-900">Salon owners</h3>
              <p className="text-sm text-rose-700">Reliable inventory, professional pricing, and fast restocking.</p>
            </div>
            <div className="rounded-xl bg-white shadow-sm border border-[#F3E0E7] p-5 space-y-2 text-left">
              <h3 className="font-semibold text-rose-900">Beauty professionals</h3>
              <p className="text-sm text-rose-700">Salon-tested formulas that deliver consistent, client-safe results.</p>
            </div>
            <div className="rounded-xl bg-white shadow-sm border border-[#F3E0E7] p-5 space-y-2 text-left">
              <h3 className="font-semibold text-rose-900">Home users</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-nowrap overflow-x-auto gap-6 max-w-5xl mx-auto pb-4 px-2 pr-8 snap-x snap-mandatory -mx-2 scrollbar-blue">
          <div className="flex-none w-[280px] snap-start">
            <div className="mb-4">
              <ImageCarousel 
                images={[getProductImage(0, 'Face & Skin Care')]}
              />
            </div>
          ...
          <div className="flex-none w-[280px] snap-start">
            <div className="mb-4">
              <ImageCarousel 
                images={[getProductImage(1, 'Hair & Styling')]}
              />
            </div>
          ...
          <div className="flex-none w-[280px] snap-start">
            <div className="mb-4">
              <ImageCarousel 
                images={[getProductImage(2, 'Salon Equipment')]}
              />
            </div>
          ...
          <div className="flex-none w-[280px] snap-start">
            <div className="mb-4">
              <ImageCarousel 
                images={[getProductImage(3, 'Bundles & Kits')]}
              />
            </div>
      ...
      {activeProduct && (
        <div className="py-16 bg-white border-t border-[#EFD6DE]">
